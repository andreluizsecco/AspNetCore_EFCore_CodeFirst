...
namespace AspNetCore_EFCore_CodeFirst.Migrations
{
    ...
    [Migration("20210623011237_Initial")]
            ...
            modelBuilder.Entity("AspNetCore_EFCore_CodeFirst.Models.Livro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Autor = "Eric Evans",
                            CategoriaID = 1,
                            DataEntrada = new DateTime(2021, 6, 22, 22, 12, 36, 860, DateTimeKind.Local).AddTicks(872),
                            Preco = 59.90m,
                            Quantidade = 26,
                        ...
                        new
                        {
                            ...
                            CategoriaID = 1,
                            DataEntrada = new DateTime(2021, 6, 22, 22, 12, 36, 861, DateTimeKind.Local).AddTicks(243),
                            Preco = 45.90m,
                            Quantidade = 13,
                        ...
                        new
                        {
                            ...
                            Autor = "Robert C. Martin",
                            CategoriaID = 1,
                            DataEntrada = new DateTime(2021, 6, 22, 22, 12, 36, 861, DateTimeKind.Local).AddTicks(257),
                            Preco = 33.90m,
                            Quantidade = 10,
                        ...
                        new
                        {
                            ...
                            Autor = "Vaughn Vernon",
                            CategoriaID = 1,
                            DataEntrada = new DateTime(2021, 6, 22, 22, 12, 36, 861, DateTimeKind.Local).AddTicks(260),
                            Preco = 59.90m,
                            Quantidade = 22,
                        ...
                        new
                        {
                            ...
                            Autor = "Scott Millet",
                            CategoriaID = 1,
                            DataEntrada = new DateTime(2021, 6, 22, 22, 12, 36, 861, DateTimeKind.Local).AddTicks(261),
                            Preco = 42.90m,
                            Quantidade = 15,
                        ...
                        new
                        {
                            ...
                            Autor = "Martin Fowler",
                            CategoriaID = 1,
                            DataEntrada = new DateTime(2021, 6, 22, 22, 12, 36, 861, DateTimeKind.Local).AddTicks(263),
                            Preco = 31.90m,
                            Quantidade = 5,
